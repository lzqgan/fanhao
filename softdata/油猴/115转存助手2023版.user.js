// ==UserScript==
// @name         115转存助手2023版
// @name:zh      115转存助手2023版
// @description  2023.10.25 更新，115转存助手 (2023)(based on Fake115Upload 1.4.3 @T3rry)
// @author       Never4Ever & tb
...
var CreateDownloadTask, CreateDownloadTask_, browserInterface, bytesToString, g_key_l, g_key_s, g_kts, m115_asym_decode, m115_asym_encode, m115_decode, m115_encode, m115_getkey, m115_sym_decode, m115_sym_encode, ref, stringToBytes, xor115_enc;
class MyRsa {
  constructor () {
...
(function () {
    ...
    const TIPS = {
        CurrentVersion: "2023",
        LastUpdateDate: "2023",
        VersionTips: "115转存助手2023版",
        UpdateUrl: "http://sha1.huizhi.tech",
    ...
    function config() {
        ...
        GM_config.init({
            ...
            title: GM_config.create('a', {
                ...
                title: `作者：Never4Ever & tb 版本：${TIPS.CurrentVersion}点击访问主页`
            }),
            isTabs: true,
            skin: 'tab',
            css: windowCss,
    ...
    function AddDownloadSha1Btn(jNode) {
        ...
        if (document.getElementById('downsha1') == null) {
            ...
            $btn[0].addEventListener('click', e => {
                ...
                var retVal = confirm('因115接口原因，插件已无法使用，点击“确定”获取SHA1独立下载工具\n\r       注：工具有会员限制，也不是所有的SHA1都还能下载，具体请看详情介绍，或发链接给客服测试一下哦                                    ' );
               if( retVal == true ) {
                window.location.href="http://sha1.huizhi.tech";
               } else {
        ...
        if (save != null && document.querySelector('#saveTip') == null) {
            save.insertAdjacentHTML('afterend', `<div id="saveTip"><p style="margin-left:20px;margin-top:-20px;"><span style="color:red;">因115接口原因，插件已无法使用，<a id="a01" href="javascript:void(0);" style="color:red;" >【点此获取 SHA1链接独立下载工具】</a></span></p></div>`);
